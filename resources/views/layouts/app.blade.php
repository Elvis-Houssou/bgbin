            ...
            <footer class="py-5">
                <div class="row">
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 5") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 6") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 7") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 8") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 9") !!}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 11") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 12") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 13") !!}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 12") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 15") !!}</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">{!! __("message.foot 16") !!}</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        ...
                        <ul class="nav d-flex justify-content-between">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis"><button type="button" class="btn btn-light btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                                <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
                            </svg></button></a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis">
                            ...
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis"><button type="button" class="btn btn-light btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                            ...
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis"><button type="button" class="btn btn-light btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
                                <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                            </svg></button></a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis"><button type="button" class="btn btn-light btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16">
                            ...
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-dark-emphasis"><button type="button" class="btn btn-light btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">

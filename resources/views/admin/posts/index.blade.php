        ...
        <div class="container">
            ...
            <div class="row" style="padding-top: 5rem;">
                <div class="col-lg-12 margin-tb text-end">
                    <div class="pull-right">
                        <a href="{{ route('createPosts') }}"> <button class="btn btn-success">Create New Product</button></a>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td> {{$post->link}} </td>
                    <td> <img src="{{asset('images/'.$post->images)}}" alt="" class="rounded" width="60" height="60"></td>

                    <td>
                        <form action=" {{ route('destroyProduct', $post->id) }} " method="POST">
                                @csrf
                            <span class="edit">
